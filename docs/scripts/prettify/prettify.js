...
(function() {
    ...
    function m(a) {
      ...
      return (f = r[b])
        ...
        : '0' <= b && b <= '7'
          ...
          : b === 'u' || b === 'x' ? parseInt(a.substring(2), 16) : a.charCodeAt(1);
    }
    function e(a) {
  ...
  var v = [ 'break,continue,do,else,for,if,return,while' ],
    ...
    w = [
      w,
      'debugger,eval,export,function,let,null,set,undefined,var,with,Infinity,NaN'
    ],
    I = [
      v,
      'and,as,assert,class,def,elif,except,exec,finally,from,global,import,in,is,lambda,nonlocal,not,or,pass,print,raise,try,with,yield,False,True,None'
    ],
    J = [
      v,
